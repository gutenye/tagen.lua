...
describe ["Array"] = function()
  ...
  describe ["#__eq"] = function()
    ...
    it ["return true if array is multi-dimensional"] = function()
      a = Array{1, Array{11, 12, Array{22}}, 2}
      b = Array{1, Array{11, 12, Array{22}}, 2}
      c = Array{1, Array{11, 12, Array{23}}, 2}
  ...
  describe ["#fetch"] = function()
    ...
    it ["call func if index is invalid and func is given"] = function()
      a = Array{11}

      ret = a:fetch(100, function(i) return i end)
      expect(ret).to_equal(100)
    end
  end

  describe ["#first"] = function()
    it ["return first object when n is not given"] = function()
      a = Array{11, 12}

      expect(a:first()).to_equal(11)
    end

    it ["return array when n is given"] = function()
      a = Array{11, 12, 13}
      b = Array{11}

      expect(a:first(1)).to_equal(b)
    end
  ...
  describe ["#last"] = function()
    it ["return last object when n is not give"] = function()
      a = Array{11, 12}

      expect(a:last()).to_equal(12)
    end

    it ["return a new array if n is given"] = function()
      a = Array{11, 12, 13}
      b = Array{13}

      expect(a:last(1)).to_equal(b)
    end
  ...
  describe ["#push"] = function()
    it ["push obj.. into array"] = function()
      a = Array({1, 2})
      b = Array({1, 2, 3, 4})
  ...
  describe ["#pop"] = function()
    it ["return object when n is not given"] = function()
      a = Array{1, 2, 3, 4}
      b = 4
      a2 = Array{1, 2, 3}

      expect(a:pop()).to_equal(b)
      expect(a).to_equal(a2)
    end
    ...
    it ["return array when n is given"] = function()
      ...
      expect(a:pop(1)).to_equal(b)
      expect(a).to_equal(a2)
    end
  end

  describe ["#shift"] = function()
    it ["return item when n is not given"] = function()
      a = Array{1, 2, 3, 4}
      b = 1
      a2 = Array{2, 3, 4}
